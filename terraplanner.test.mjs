...
describe('Teste de Aceitação de Pesquisa de Mapa do TerraPlanner', function() {
    ...
    it('deve pesquisar um endereço completo e válido e centralizar o ponto exato', async function() {
        ...
        await driver.manage().window().maximize(); // Maximiza a janela para melhor visualização durante a execução
        ...
        // Verificação: Garante que nenhuma mensagem de erro seja exibida para um endereço válido.
        // Como não foi achado algum id ou classe o idela é usar o XPath para encontrar o elemento que contém o texto da mensagem de erro.
    ...
    it('deve exibir notificação de erro para um endereço inexistente', async function() {
        ...
        // A nossa expectativa é que a mesma notificação de erro apareça
        const notificationSelector = By.css('div[role="status"][data-state="open"]');

        try {
            // O teste vai esperar a notificação aparecer...
            ...
            // ... e vai verificar se ela está visível e com o texto correto.
            // (Podemos assumir que a mensagem seria a mesma, ou ajustá-la se fosse diferente)
            ...
            // A mensagem de erro poderia ser diferente, mas vamos usar a conhecida por enquanto.
    ...
    it('deve exibir a notificação de erro da API ao pesquisar com o campo vazio', async function() {
        ...
        try {
            ...
            // Pega o texto COMPLETO de dentro da notificação
            const notificationText = await notification.getText();
            ...
            // Se o wait falhar, o teste falha com uma mensagem clara.
    ...
    it('deve pesquisar um endereço e selecionar a primeira sugestão', async function() {
        ...
        // Verificação final para garantir que nenhum pop-up de erro apareceu
        const notificationSelector = By.css('div[role="status"][data-state="open"]');
    ...
    it('deve planejar uma rota e definir o tipo de estrada como mais rápida', async function() {
        this.timeout(45000); // Tempo limite
        ...
        // JavaScript para forçar o clique, garantindo a interação
